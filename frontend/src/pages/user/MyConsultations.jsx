    ...
    <div className="min-h-screen bg-gray-50 py-8 pt-24">
      <div className="container mx-auto px-6">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-primary">My Consultations</h1>
          <p className="text-gray-600 mt-2">View all your consultation requests</p>
        </div>

        {/* Single Tab - Only Consultations */}
        <div className="mb-6">
          <div className="pb-3 px-4 font-semibold text-blue-600 border-b-2 border-blue-600">
